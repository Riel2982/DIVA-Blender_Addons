...
translation_dict = {
    "ja_JP": {
        # brt_preferences.py:55
        ("*", "Editing Identifier Sets"): "識別子セット編集",
        # brt_preferences.py:85
        ("*", "Set name"): "セット名",
        # brt_preferences.py:92
        ("*", "Right"): "右",
        # brt_preferences.py:93
        ("*", "Left"): "左",
        # brt_preferences.py:100
        ("*", "Add a pair"): "ペアを追加",
        # brt_preferences.py:110
        ("*", "Add Identifier Set"): "識別子セットを追加",
        # brt_preferences.py:111
        ("*", "Restore Default Set"): "デフォルトセットを復元",
        # brt_preferences.py:114
        ("*", "Synchronize"): "同期",
        # brt_preferences.py:115
        ("*", "Reset"): "リセット",
        # brt_preferences.py:116
        ("*", "Save"): "保存",
        # brt_preferences.py:123
        ...
        # brt_preferences.py:176
        ("*", "Already at the top"): "既に先頭にあります",
        # brt_preferences.py:180
        ("*", "Moved up"): "上に移動しました",
        ...
        # brt_types.py:133, brt_ui_rename.py:39
        ...
        # brt_types.py:139, brt_ui_replace.py:46
        ...
        # brt_types.py:145, brt_ui_invert.py:75
        ...
        # brt_ui_invert.py:98, brt_ui_other.py:117, brt_ui_other.py:61, brt_ui_rename.py:72, brt_ui_replace.py:68
        ("*", "No bones selected"): "ボーンを選択してください",
        # brt_ui_invert.py:117
        ("*", "No bones were renamed. Operation cancelled."): "リネーム対象ボーンが見つかりません",
        # brt_ui_invert.py:120
        ...
        # brt_ui_other.py:44, brt_ui_other.py:69
        ("*", "All target names already had .R/.L suffixes; no changes made"): "既に.R/.Lの識別接尾辞が付与済みです",
        # brt_ui_other.py:46, brt_ui_other.py:71
        ("*", "No bone name with left/right identifier was found"): "左右識別子がついたボーン名がありませんでした",
        # brt_ui_other.py:50, brt_ui_other.py:75
        ("*", "Symmetric renaming applied successfully"): "左右識別子の付与が完了しました",
        # brt_ui_other.py:86
        ("*", "Revert left/right identification suffixes"): "左右識別接尾辞を削除する",
        # brt_ui_other.py:102, brt_ui_other.py:124
        ("*", "Undo target identifier not found"): "元に戻す対象の識別子が見つかりませんでした",
        # brt_ui_other.py:106, brt_ui_other.py:128
        ...
        # brt_uix_update.py:24
        ("*", "Update"): "アップデート",
        # brt_uix_update.py:27
        ("*", "Check for Updates"): "更新を確認",
        # brt_uix_update.py:30
        ("*", "Install"): "インストール",
        # brt_uix_update.py:31
        ("*", "Open Addon Folder"): "アドオンフォルダを開く",
        # brt_uix_update.py:45
        ("*", "GitHub has a preview release: "): "Githubにプレリリースあり",
        ...
        # brt_uix_update.py:76
        ("*", "Update file list: "): "更新ファイル一覧：",
        # brt_uix_update.py:109
    ...
    "en_US": {
        ...
        # brt_ui_invert.py:117
        ("*", "No bones were renamed. Operation cancelled."): "No bones were renamed. Operation cancelled.",
        # brt_ui_invert.py:120
        ...
        # brt_ui_other.py:44, brt_ui_other.py:69
        ("*", "All target names already had .R/.L suffixes; no changes made"): "All target names already had .R/.L suffixes; no changes made",
        # brt_ui_other.py:46, brt_ui_other.py:71
